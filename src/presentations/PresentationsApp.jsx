...
import { getToken, clearToken, login as apiLogin, humanizeError, getTokenExpiryMs, refreshSession } from './presentationsApi.js'
...
export default function PresentationsApp() {
  ...
  const expiryWarning = useSessionExpiry(authed, signOut, getTokenExpiryMs, refreshSession)
