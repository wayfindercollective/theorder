...
const SECTION_DEFS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: ['commitmentGate', 'button'], label: 'Button text', hint: 'Reveals the booking calendar. e.g. Book My Call' },
    ],
  },
  {
    ...
    fields: [
      ...
      { path: ['consent', 'termsLabel'],    label: 'Terms link text', hint: 'Link text shown under the calendar. Leave blank to hide.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: ['finalScreen', 'bookedEyebrow'], label: 'Booked — eyebrow', hint: 'Replaces the eyebrow the moment a call is booked. e.g. Confirmed' },
      { path: ['finalScreen', 'bookedHeading'], label: 'Booked — heading', hint: 'Replaces the heading once the call is booked. e.g. Your Call Is Booked' },
      { path: ['finalScreen', 'bookedSub'], label: 'Booked — message', textarea: true, hint: 'Line shown after the booked date and time. e.g. Check your email for the confirmation and calendar invite.' },
