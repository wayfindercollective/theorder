...
const SECTION_DEFS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: ['evidence', 'cards', 0, 'attribution'], label: 'Testimonial 1 — name', hint: 'Who said it. e.g. — James, Selection 2025' },
      { path: ['evidence', 'cards', 1, 'quote'],       label: 'Testimonial 2 — quote', textarea: true, rows: 4, hint: 'The quote. Leave blank to hide this card.' },
      { path: ['evidence', 'cards', 1, 'attribution'], label: 'Testimonial 2 — name' },
